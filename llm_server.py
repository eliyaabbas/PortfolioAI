...
- When listing skills, projects, or tools, use a bulleted list with bold labels.
- Use short, punchy sentences — NOT dense paragraphs.
- Emojis are welcome but don't overdo it (1-2 per response max).
"""
